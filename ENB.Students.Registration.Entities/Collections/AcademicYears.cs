...
namespace ENB.Students.Registration.Entities.Collections
{
    ...
    /// </summary>
    public class AcademicYears : CollectionBase<AcademicYear>
    {
        /// <summary>
        ...
        public AcademicYears(IList<AcademicYear> initialList) : base(initialList) { }

        /// <summary>
        /// Initializes a new instance of the <see cref="Operators"/> class.
        /// </summary>
        /// <param name="initialList">Accepts a CollectionBase of Person as the initial list.</param>
        public AcademicYears(CollectionBase<AcademicYear> initialList) : base(initialList) { }
        ...
        public IEnumerable<ValidationResult> Validate()
        {
            ...
            foreach (var academiyear in this)
            {
                errors.AddRange(academiyear.Validate());
            }
            return errors;
        }
    }
