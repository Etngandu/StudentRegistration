...
{
    public class EditAcademicYearCommandHandler : ICommandHandler<EditAcademicYearCommand, ErrorOr<CreateAndEditAcademicYear>>
    {
        ...
        public async Task<ErrorOr<CreateAndEditAcademicYear>> Handle(EditAcademicYearCommand request, CancellationToken cancellationToken)
        {
